   ...
   return (
      <div>
         <form onSubmit={formik.handleSubmit} className={style.container}>
            <FormControl>
               <FormLabel className={style.title}>Personal Information</FormLabel>
               <FormGroup className={style.inputBlock}>
                  ...
                  {formik.errors.fullName ? (
                     <div style={{ color: 'var(--textErrorColor)' }}>{formik.errors.fullName}</div>
                  ) : null}
                  <TextField
                     label={'About Me'}
                     inputProps={{ style: { color: 'var(--textMainColor)' } }}
                  ...
                  {formik.errors.aboutMe ? (
                     <div style={{ color: 'var(--textErrorColor)' }}>{formik.errors.aboutMe}</div>
                  ) : null}
                  <TextField
                  ...
                  {formik.errors.lookingForAJobDescription ? (
                     <div style={{ color: 'var(--textErrorColor)' }}>
                        {formik.errors.lookingForAJobDescription}
                     </div>
                  ) : null}
                  <FormControlLabel
